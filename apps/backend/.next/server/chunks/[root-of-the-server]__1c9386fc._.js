module.exports = [
"[project]/Documents/xeno/shopify-mt/apps/backend/.next-internal/server/app/api/analytics/new-vs-returning/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/Documents/xeno/shopify-mt/apps/backend/src/app/api/analytics/new-vs-returning/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$xeno$2f$shopify$2d$mt$2f$apps$2f$backend$2f$src$2f$lib$2f$shopify$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminFetch"])(shop, ORDERS_QUERY, {
            ordersQuery,
            first: 250
        });
        const orders = (data.orders.edges || []).map((e)=>e.node).filter((o)=>o.customer);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1c9386fc._.js.map